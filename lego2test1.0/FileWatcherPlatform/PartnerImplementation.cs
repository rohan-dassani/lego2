...
//         this.fileWatcherService.FileChanged += OnFileChanged;
//     }

//     public void Start()
//     {
//         fileWatcherService.Subscribe(partnerId, directoryPath);
...
//     private Task OnFileChanged(string partnerId, FileInfo fileInfo)
//     {
...
//     private Task OnFileChanged(string partnerId, FileInfo fileInfo)
//     {
//         Console.WriteLine($"Partner {this.partnerId}");
...
//subscribe directly to filewatcher
public class Partner
{
    private readonly string partnerId;
    private readonly string directoryPath;
