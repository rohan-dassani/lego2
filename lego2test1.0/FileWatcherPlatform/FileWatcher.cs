...
//     public FileWatcher(string directoryPath, Func<FileInfo, Task> onFileEvent, Action<Exception> onErrorEvent)
//     {
...
//         watcher.Filter = "*.*";
//         watcher.InternalBufferSize = 16*4096;
//         watcher.Changed += OnChanged;
//         watcher.Error += OnError;
...
// more logs and using partner subscription to events
